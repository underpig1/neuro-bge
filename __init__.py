bl_info = {
    ...
    "warning": "Save your work before run; do not modify work during run",
    "category": "Object",
}
...
class OnInteractionEvent(LogicNode):
    ...
    def init(self, context):
        self.outputs.new("NodeSocketShader", "Script")
        self.outputs.new("NodeSocketObj", "Interaction")
...
class ObjectiveInput(InputNode):
    ...
    def init(self, context):
        self.outputs.new("NodeSocketObj", "Object")
...
class InteractionInput(InputNode):
    ...
    def init(self, context):
        self.inputs.new("NodeSocketObj", "Object")
...
class PathfindingAgentController(ActionNode):
    ...
    def init(self, context):
        ...
        self.inputs.new("NodeSocketObj", "Target")
        super().init(context)
...
class NodeSocketObj(bpy.types.NodeSocket):
    bl_idname = "NodeSocketObj"
